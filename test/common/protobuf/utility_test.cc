...
TEST_F(ProtobufUtilityTest, HashCache) {
  Protobuf::StringValue str1, str2, str3;
  ...
  Protobuf::Struct struct1, struct2, struct3;
  ...
  Protobuf::ListValue list1, list2, list3;
  ...
  Protobuf::Value nested_value1, nested_value2, nested_value3;
  ...
  Protobuf::Value deep_nested_value1, deep_nested_value2;
...
TEST_F(ProtobufUtilityTest, MessageUtilRecursiveHash) {
  ...
  Protobuf::BytesValue bytes1, bytes2;
...
TEST_F(ProtobufUtilityTest, MessageUtilHashComprehensive) {
  ...
  {
    // Int32Value
    Protobuf::Int32Value int1, int2, int3;
    int1.set_value(42);
    int2.set_value(42);
    int3.set_value(100);
    ...
    // UInt64Value
    Protobuf::UInt64Value uint1, uint2, uint3;
    ...
    // DoubleValue
    Protobuf::DoubleValue double1, double2, double3;
    ...
    // BoolValue
    Protobuf::BoolValue bool1, bool2, bool3;
  ...
  // Test 4: Repeated fields
  {
    ...
    Protobuf::ListValue list1, list2, list3, list4;
  ...
  {
    // Timestamp
    Protobuf::Timestamp ts1, ts2, ts3;
    ...
    // Duration
    Protobuf::Duration dur1, dur2, dur3;
  ...
  {
    Protobuf::StringValue empty_str, non_empty_str;
  ...
  // Test 10: Edge cases
  {
    ...
    // Unicode string
    Protobuf::StringValue unicode_str;
...
TEST_F(ProtobufUtilityTest, MessageUtilRecursiveHashComplex) {
  ...
  Protobuf::Struct* nested1 = (*root_struct.mutable_fields())["nested"].mutable_struct_value();
  ...
  Protobuf::Struct* nested2 = (*nested1->mutable_fields())["deeper"].mutable_struct_value();
  ...
  Protobuf::ListValue* list = (*nested2->mutable_fields())["items"].mutable_list_value();
  ...
  Protobuf::Struct* nested2_2 = (*nested1_2->mutable_fields())["deeper"].mutable_struct_value();
  (*nested2_2->mutable_fields())["level"].set_string_value("level3");
  (*nested2_2->mutable_fields())["final"].set_bool_value(true);

  Protobuf::ListValue* list2 = (*nested2_2->mutable_fields())["items"].mutable_list_value();
  ...
  Protobuf::Struct modified_struct = root_struct;
  ...
  Protobuf::Struct modified_nested = root_struct;
  Protobuf::Struct* nested_mod =
  ...
  Protobuf::Struct modified_deep = root_struct;
  Protobuf::Struct* nested_deep =
      (*modified_deep.mutable_fields())["nested"].mutable_struct_value();
  Protobuf::Struct* deeper_deep =
...
TEST_F(ProtobufUtilityTest, MessageUtilHashFieldTypes) {
  ...
  Protobuf::Struct null_struct;
  (*null_struct.mutable_fields())["null_field"].set_null_value(Protobuf::NullValue::NULL_VALUE);
...
TEST_F(ProtobufUtilityTest, MessageUtilRecursiveHashEdgeCases) {
  ...
  Protobuf::Struct empty_struct;
  Protobuf::StringValue empty_string;
  ...
  Protobuf::Int32Value default_int;
  Protobuf::BoolValue default_bool;
  Protobuf::StringValue default_string;
  ...
  Protobuf::Int32Value zero_int;
  zero_int.set_value(0);
  Protobuf::UInt64Value zero_uint;
  zero_uint.set_value(0);
  Protobuf::DoubleValue zero_double;
  ...
  Protobuf::Int64Value max_int64;
  max_int64.set_value(INT64_MAX);
  Protobuf::Int64Value min_int64;
  min_int64.set_value(INT64_MIN);
  Protobuf::UInt64Value max_uint64;
  ...
  Protobuf::BytesValue binary_msg;
  ...
  (*mixed_struct.mutable_fields())["null"].set_null_value(Protobuf::NullValue::NULL_VALUE);
...
TEST_F(ProtobufUtilityTest, MessageUtilHashCollisionDetection) {
  ...
  std::vector<Protobuf::StringValue> messages;

  // Generate 1000 different messages
  for (int i = 0; i < 1000; ++i) {
    Protobuf::StringValue msg;
  ...
  std::vector<Protobuf::Struct> similar_structs;
